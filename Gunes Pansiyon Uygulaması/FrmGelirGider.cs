...
namespace Gunes_Pansiyon_Uygulaması
{
    public partial class FrmGelirGider : Form
    {
        ...
        SqlConnection baglanti = new SqlConnection(@"Data Source=BURAK\SQLEXPRESS;Initial Catalog=GunesPansiyon;Integrated Security=True");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            int sonuc;
            sonuc = Convert.ToInt32(LblKasaToplam.Text) - (Convert.ToInt32(LblPersonelMaas.Text) + Convert.ToInt32(LblAlınanUrun1.Text) + Convert.ToInt32(LblAlınanUrun2.Text) + Convert.ToInt32(LblAlınanUrun3.Text) + Convert.ToInt32(LblFaturalar1.Text) + Convert.ToInt32(LblFaturalar2.Text) + Convert.ToInt32(LblFaturalar3.Text));
